...
public class Comanda {
    ...
    public void addprimer(String plat, Integer quantitat, boolean hecho) {
        Object[] o = new Object[]{quantitat, hecho,null};
        primers.put(plat, o);
    }
...
public void setPrimerSalido(String plato) {
        Object[] o = this.primers.get(plato);
        o[2] = true;
        this.primers.put(plato, o);
    }

    public void setSegonSalido(String plato) {
        Object[] o = this.segons.get(plato);
        o[2] = true;
        this.segons.put(plato, o);
    }
    ...
    public Map<Integer, ArrayList<String[]>> exportDataArrayCocina() {
        ...
        for (int i = 0; i < this.primers.size(); i++) {
            ...
            varStr[5] = (boolean) ((Object[]) this.primers.values().toArray()[i])[1] ? "X" : " ";
            varStr[7] = ((Object[]) this.primers.values().toArray()[i])[2]==null?"false":((Object[]) this.primers.values().toArray()[i])[2].toString();
            lineascomanda.add(varStr);
        }
        for (int i = 0; i < this.segons.size(); i++) {
            varStr = new String[8];
            ...
            varStr[4] = this.datacomanda.toString();
            varStr[5] = (boolean) ((Object[]) this.segons.values().toArray()[i])[1] ? "X" : " ";
            varStr[7] = ((Object[]) this.segons.values().toArray()[i])[2]==null?"false":((Object[]) this.segons.values().toArray()[i])[2].toString();
            lineascomanda.add(varStr);
        }
        for (int i = 0; i < this.postres.size(); i++) {
            varStr = new String[8];
            ...
            varStr[4] = this.datacomanda.toString();
            varStr[5] = (boolean) ((Object[]) this.postres.values().toArray()[i])[1] ? "X" : " ";
varStr[7] = ((Object[]) this.postres.values().toArray()[i])[2]==null?"false":((Object[]) this.postres.values().toArray()[i])[2].toString();
            lineascomanda.add(varStr);
        }
          Map<Integer,ArrayList<String[]>> mapa =new HashMap<>();
          mapa.put(this.taula, lineascomanda);
