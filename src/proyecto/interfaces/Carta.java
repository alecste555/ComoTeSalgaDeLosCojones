        ...
        for (int i = 0; i < jTable1.getModel().getRowCount(); i++) {
            if (Integer.parseInt((String) jTable1.getModel().getValueAt(i, 8)) > 0) {
                ...
                try {
                    ...
                    case primer -> c.addprimer((String) jTable1.getModel().getValueAt(i, 1), Integer.valueOf((String) jTable1.getModel().getValueAt(i, 8)),false);
                    case segon -> c.addsegon((String) jTable1.getModel().getValueAt(i, 1), Integer.valueOf((String) jTable1.getModel().getValueAt(i, 8)),false);
                    case postre -> c.addpostre((String) jTable1.getModel().getValueAt(i, 1), Integer.valueOf((String) jTable1.getModel().getValueAt(i, 8)),false);
